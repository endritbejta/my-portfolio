...
export const profile = {
  ...
  about: [
    ...
    "Since 2022 I've been the engineer behind four production storefronts at GRENION Brands (Berlin, remote) — Banana Beauty, HelloBody, MyRapunzel and Sophie Rosenburg. I own them end-to-end: reusable component architecture in Liquid, TypeScript and React across three theme codebases, headless work with Hydrogen, API and app integrations, and A/B experiments designed with marketing. Sustained performance work has lifted Google PageSpeed scores by up to 20 points per storefront.",
